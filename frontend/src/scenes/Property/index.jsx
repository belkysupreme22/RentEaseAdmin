              ...
              >
                <CardContent>
                  ...
                  {property.image.length > 0 && (
                    <Box mt="10px" position="relative">
                      <CardMedia
                        component="img"
                        height="140"
                        image={`http://10.139.161.59:8000/uploads/${property.image[imageData[property._id]?.currentIndex || 0]}`}
                        alt="property"
                  ...
                  <Box display="flex" alignItems="center" mt="10px" gap="10px">
                    <img
                      src={`http://10.139.161.59:8000/uploads/${property.ownerProfilePic}`}
                      alt="Owner"
                      style={{
                        width: '50px',
                        height: '50px',
