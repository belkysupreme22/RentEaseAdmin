              ...
              >
                <CardContent>
                  <Box display="flex" alignItems="center" mb={2}>
                    <Avatar
                      src={`http://10.139.161.59:8000/uploads/${tenant.profile_picture}`}
                      ...
                      onClick={() => handleImageClick(`http://10.139.161.59:8000/uploads/${tenant.profile_picture}`)}
                    />
      ...
      {selectedTenant && (
        <Dialog open={open} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
          ...
          <DialogContent>
            <Box display="flex" alignItems="center" mb={2}>
              <Avatar
                src={`http://10.139.161.59:8000/uploads/${selectedTenant.profile_picture}`}
